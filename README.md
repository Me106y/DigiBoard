...
<div align="center">
  <img src="https://img.shields.io/badge/📺-B站演示视频-00A1D6?style=for-the-badge&logo=bilibili](https://github.com/user-attachments/assets/1f4ab039-659b-4eb4-8250-c13f2d39793a" alt="演示视频">
</div>
...
## 🙏 致谢
DigiBoard 的诞生离不开开源社区的智慧与支持。在此致以诚挚的谢意：

感谢 PaddleSeg 提供的高效语义分割工具与丰富的预训练模型，为本项目的人像分割模块奠定了坚实基础。

感谢 CS-23-SW-6-21 在架构设计上提供的宝贵思路，为项目的顺利推进提供了关键支持。
