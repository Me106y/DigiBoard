...
- **🚀 实时端侧推理**：针对移动端深度优化，在主流手机上可达 **20FPS+** 的处理速度，端到端延迟低于50ms。
- **🖼️ 精准语义分割**：集成 **EASPP（Efficient Atrous Spatial Pyramid Pooling）** 模块的轻量级分割模型，精确提取演示者人像掩模，准确定位被遮挡区域。
...
- **📱 跨平台支持**：提供Android、iOS Demo应用及Linux命令行工具，方便二次开发与集成。
...
<div align="center">
  <img width="800" alt="DigiBoard架构图" src="YOUR_ARCHITECTURE_IMAGE_URL_HERE" />
